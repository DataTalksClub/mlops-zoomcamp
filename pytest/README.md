...
## the outout of this command is a encrypted string which is given as the inputfor the below command for shared-iterator


```bash
aws  --endpoint-url=http://localhost:4566 \
        kinesis get-records --shard-iterator \
        "AAAAAAAAAAGtNzhFOPrfSo4jsZeOB/LHkbnP3F0mSqjYs9f1HNv+jDasYxcgBCEv6PNPGKUqkmN7OK+rYebMq33/Xuc4KcyBNS/LJ4cy5mdTzF8XsYSPLhfFpTowT6dxryJhGi2psd1CDXbOz9n+WUovzyOXMx1wYLPi6pVD0WHHJNsLp7k2oYjzFE/zQN2G2Mjc0riemCojknICuCbBv0VWRil7gVDI"
```
