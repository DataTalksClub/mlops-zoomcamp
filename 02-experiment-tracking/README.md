...
* [Notes from froukje](https://github.com/froukje/ml-ops-zoomcamp/blob/master/week02_Experiment_tracking_and_model_management/week02.ipynb) and [post on medium](https://medium.com/@falbrechtg/getting-started-with-mlflow-tracking-46a0089d6a73)
