...
#    input_file = f's3://nyc-tlc/trip data/{taxi_type}_tripdata_{year:04d}-{month:02d}.parquet'
    output_file = f's3://mlflow-artifacts-gansi/taxi_type={taxi_type}/year={year:04d}/month={month:02d}/{run_id}.parquet'
...
def run():
    ...
    run_id = sys.argv[4] # '9129b1c2b1ce401e9ab1d1d94a19249b'
