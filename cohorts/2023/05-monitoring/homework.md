...
Start with `baseline_model_nyc_taxi_data.ipynb`. Download the March 2022 Green Taxi data. We will use this data to simulate a production usage of a taxi trip duration prediction service.
